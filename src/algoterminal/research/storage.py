...
~/.algoterminal/research/<slug>/<version>/, so a strategy's iteration
history is fully browsable later:

    ~/.algoterminal/research/momentum-fx-carry/
        20260401-101500/
            hypothesis.yaml
            data_quality.yaml
            strategy.py
...
from algoterminal.config import RESEARCH_DIR, ensure_dirs
